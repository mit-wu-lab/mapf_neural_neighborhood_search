...
winPIBT::winPIBT(PProblem* _P, int _w, bool _softmode)
  : PSolver(_P), w(_w), softmode(_softmode)
{
  init();
}

winPIBT::winPIBT(PProblem* _P, int _w, bool _softmode, std::mt19937* _MT)
  : PSolver(_P, _MT), w(_w), softmode(_softmode)
{
  init();
}
