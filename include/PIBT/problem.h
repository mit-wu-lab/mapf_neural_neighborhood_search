...
public:
  PProblem(Graph* _G, PIBT_Agents _A, std::vector<Task*> _T);
  PProblem(Graph* _G, PIBT_Agents _A);
  PProblem(Graph* _G, PIBT_Agents _A, std::vector<Task*> _T, std::mt19937* _MT);
  PProblem(Graph* _G, PIBT_Agents _A, std::mt19937* _MT);
